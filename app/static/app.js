...
const ICON_REMOTE_OVERRIDES = {
  ...
  roguedashboard: "/icons/roguedashboard-approved-128.png?v=1.3.1",
};
...
async function load() {
  try {
    ...
    app.innerHTML = `<main class="center-stage"><section class="error-card"><div class="brand-mark"><img data-rgd-brand-image src="/branding/roguedashboard-approved.webp?v=1.3.1" alt="RogueDashboard"></div><h1>Dashboard unavailable</h1><p>${escapeHtml(error.message)}</p><button class="button primary" id="retry">Try again</button></section></main>`;
  ...
  app.innerHTML = `
    <main class="setup-shell">
      ...
      <section class="setup-card">
        <header class="setup-brand"><div class="brand-mark"><img data-rgd-brand-image src="/branding/roguedashboard-approved.webp?v=1.3.1" alt="RogueDashboard"></div><div><strong>RogueDashboard</strong><span>Service dashboard</span></div></header>
  ...
  app.innerHTML = `
    <div class="app-shell theme-${escapeHtml(dashboard.meta.theme)} background-${escapeHtml(dashboard.meta.backgroundMode)} density-${escapeHtml(dashboard.meta.density)} ${state.editor ? "editing" : ""}" id="shell">
      ...
      <main class="dashboard ${dashboard.meta.fullWidth ? "full-width" : ""}">
        <header class="topbar">
          <div class="brand-block"><div class="brand-mark small"><img data-rgd-brand-image src="/branding/roguedashboard-approved.webp?v=1.3.1" alt=""></div><div><h1>${escapeHtml(dashboard.meta.title)}</h1><p>${escapeHtml(dashboard.meta.subtitle)}</p></div></div>
  ...
  return `<aside class="editor-panel">
    <header class="editor-header">
      <div class="editor-brand">
        <img src="/icons/roguedashboard-approved-128.png?v=1.3.1" alt="">
      ...
      <section class="editor-section editor-tab-panel ${state.editorTab === "admin" ? "active" : ""}" data-editor-panel="admin">
        ...
        <div class="editor-card">
          ...
          <div class="admin-summary-grid">
            ...
            <div><span>Version</span><strong>${escapeHtml(state.bootstrap?.version || "1.3.1")}</strong></div>
          </div>
        </div>
        <div class="editor-card">
  ...
  overlay.innerHTML = `<div class="modal-backdrop auth-backdrop">
    <section class="modal auth-modal">
      <div class="auth-visual">
        <img src="/branding/roguedashboard-approved.webp?v=1.3.1" alt="RogueDashboard">
