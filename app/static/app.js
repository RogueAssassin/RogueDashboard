...
const ICON_FILES = {
  ...
  roguemediavalidator: "roguemediavalidator-approved-128.png", mediavalidator: "roguemediavalidator-approved-128.png",
  roguevalidator: "roguemediavalidator-approved-128.png",
};
  ...
  app.innerHTML = `
    <div class="app-shell theme-${escapeHtml(dashboard.meta.theme)} background-${escapeHtml(dashboard.meta.backgroundMode)} density-${escapeHtml(dashboard.meta.density)} ${state.editor ? "editing" : ""}" id="shell">
      ...
      <main class="dashboard ${dashboard.meta.fullWidth ? "full-width" : ""}">
        ...
        ${dashboard.meta.showStats !== false ? `<section class="stat-strip" id="stats">
...
function renderGroupEditor() {
  ...
  list.querySelectorAll("[data-group-visible]").forEach(select => select.onchange = () => { state.draft.groups[Number(select.dataset.groupVisible)].visible = select.value === "true"; renderGroups(); });
