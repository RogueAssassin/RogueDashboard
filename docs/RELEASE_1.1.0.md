...
Rogue Dashboard 1.1.3 introduces first-class Docker and Podman support while preserving the existing restricted-agent security boundary.
...
The 1.1.3 release keeps the existing application regression suite and release-metadata validation gates. Docker and Podman live-host validation should be completed before the draft pull request is merged.
